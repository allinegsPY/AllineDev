...
//     { id: '1', title: 'lamp 1', image: require("../../../assets/coelho.png"), price: 'R$ 9,90', ofer: 'R$ 29,99' },
//     { id: '2', title: 'lamp 2', image: require("../../../assets/sailor.png"), price: 'R$ 9,90', ofer: 'R$ 34,99' },
//     { id: '3', title: 'lamp 3', image: require("../../../assets/coelho.png"), price: 'R$ 9,90', ofer: 'R$ 19,99' },
//     { id: '4', title: 'lamp 4', image: require("../../../assets/sailor.png"), price: 'R$ 9,90', ofer: 'R$ 15,99' },
    ...
    <View
      ...
      <FlatList
        ...
        ItemSeparatorComponent={() => (
          <View style={{backgroundColor: '#a68da8', height: 1}} />
        )}
        data={products}
        renderItem={({item}) => (
          <Card
